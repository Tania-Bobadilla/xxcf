        ...
        <form className='pt-5 space-y-10 sm:text-base'>
          ...
          <div className='flex space-x-10 items-end '>
            <div className='grid grid-cols gap-2'>
              ...
              <input type="text" className='w-48 bg-gris2 sm:w-[32rem]' />
            </div>
          ...
          <div className='grid grid-rows-2 gap-y-4'>
            <div>
              ...
              <input className='w-40 bg-gris2 sm:w-80' type="text" />
            </div>

            <div className='flex gap-4 sm:gap-2'>
              <div>
                <p>País</p>
                <input className='w-32 bg-gris2 sm:w-64' type="text" />
              </div>
              <div>
                <p>Ciudad</p>
                <input className='w-32 bg-gris2 sm:w-64' type="text" />
          ...
          <div className='grid grid-cols gap-2'>
            ...
            <input className='w-80 bg-gris2 sm:w-[32rem]' type="text" />
